 ...
 *         @OA\Property(property="id", type="integer", example=1),
 *         @OA\Property(property="name", type="string", example="Professional Safety Boot"),
 *         @OA\Property(property="slug", type="string", example="professional-safety-boot"),
 *         @OA\Property(property="base_price", type="number", format="float", example=380.00)
 *     ),
 *     @OA\Property(property="product_variant", type="object", nullable=true,
 *         @OA\Property(property="id", type="integer", example=5),
 *         @OA\Property(property="color", type="string", example="Black"),
 *         @OA\Property(property="size", type="string", example="42"),
 *         @OA\Property(property="price", type="number", format="float", example=380.00),
