...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'business_address' => 'işletme adresi',
        'website' => 'web sitesi',
        'annual_volume' => 'yıllık hacim',
        'reference_customers' => 'referans müşteriler',
        'additional_notes' => 'ek notlar',
        'dealer_code' => 'bayi kodu',
        'dealer_discount_percentage' => 'bayi iskonto oranı',
        'custom_discount_percentage' => 'özel indirim oranı',
        'credit_limit' => 'kredi limiti',
        'payment_terms_days' => 'ödeme vadesi',
        'loyalty_points' => 'sadakat puanları',
        'lifetime_value' => 'yaşam boyu değer',
        'notification_preferences' => 'bildirim tercihleri',
        'pricing_tier_id' => 'fiyatlandırma seviyesi',
        'customer_type_override' => 'müşteri tipi',
        'roles' => 'roller',
        
        // Wishlist-specific attributes
        'product_id' => 'ürün',
        'product_variant_id' => 'ürün çeşidi',
        'notes' => 'notlar',
        'priority' => 'öncelik',
        'is_favorite' => 'favori',
    ],
