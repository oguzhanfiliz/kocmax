  ...
  <div :class="`tp-product-item-2 ${spacing ? 'mb-40' : ''}`">
    ...
    >
      ...
      <div class="tp-product-badge">
        <span v-if="item.status === 'out-of-stock'" class="product-hot">Stokta Yok</span>
      </div>
      ...
      <div class="tp-product-action-2 tp-product-action-blackStyle">
        <div class="tp-product-action-item-2 d-flex flex-column">
          ...
          >
            <svg-add-cart />
            <span class="tp-product-tooltip tp-product-tooltip-right">Sepete Ekle</span>
          </button>
          <nuxt-link
            v-if="isItemInCart(item)"
            href="/cart"
          ...
          >
            <svg-add-cart />
            <span class="tp-product-tooltip tp-product-tooltip-right">Sepeti Gör</span>
          </nuxt-link>
          ...
          >
            <svg-quick-view />
            <span class="tp-product-tooltip tp-product-tooltip-right">Hızlı Önizleme</span>
          </button>
          ...
          >
            <svg-compare-2 />
            <span class="tp-product-tooltip tp-product-tooltip-right">
              {{ isItemInCompare(item) ? 'Karşılaştırmadan Kaldır' : 'Karşılaştırmaya Ekle' }}
            </span>
          </button>
        </div>
      </div>
