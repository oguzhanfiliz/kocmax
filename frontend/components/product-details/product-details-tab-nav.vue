  ...
  <div class="tp-product-details-tab-nav tp-tab">
    <nav>
      <div class="nav nav-tabs justify-content-center p-relative tp-product-tab" id="navPresentationTab" role="tablist">
        ...
        <button @click="handleActiveMarker($event)" class="nav-link" id="nav-review-tab" data-bs-toggle="tab" data-bs-target="#nav-review" type="button" role="tab" aria-controls="nav-review" aria-selected="false">Reviews ({{product?.reviews?.length || 0}})</button>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                            <div class="tp-product-details-desc-content pt-25">
                              ...
                              <h3 class="tp-product-details-desc-title">{{product?.title || 'Ürün Adı'}}</h3>
                              <p>{{ product?.description || 'Açıklama yükleniyor...' }}</p>
                            </div>
                        </div>
                      </div>
                  </div>
