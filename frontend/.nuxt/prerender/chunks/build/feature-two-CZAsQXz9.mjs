import { _ as __nuxt_component_0, a as __nuxt_component_1, b as __nuxt_component_2, c as __nuxt_component_3 } from './support-DR0JMUgP.mjs';
import { b as _export_sfc, q as formatPrice } from './server.mjs';
import { mergeProps, unref, useSSRContext } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/server-renderer/index.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</span></div><div class="tp-feature-content-2"><h3 class="tp-feature-title-2">\xDCcretsiz Teslimat</h3><p>T\xFCm sipari\u015Flerde</p></div></div></div><div class="col-xl-3 col-lg-3 col-md-6 col-sm-6"><div class="tp-feature-item-2 d-flex align-items-start"><div class="tp-feature-icon-2 mr-10"><span>`);
  _push(ssrRenderComponent(_component_svg_refund, null, null, _parent));
  _push(`</span></div><div class="tp-feature-content-2"><h3 class="tp-feature-title-2">\u0130ade &amp; Geri \xD6deme</h3><p>Para iade garantisi</p></div></div></div><div class="col-xl-3 col-lg-3 col-md-6 col-sm-6"><div class="tp-feature-item-2 d-flex align-items-start"><div class="tp-feature-icon-2 mr-10"><span>`);
  _push(ssrRenderComponent(_component_svg_discount, null, null, _parent));
  _push(`</span></div><div class="tp-feature-content-2"><h3 class="tp-feature-title-2">\xDCye \u0130ndirimi</h3><p>${ssrInterpolate(("formatPrice" in _ctx ? _ctx.formatPrice : unref(formatPrice))(140))} \xFCzeri her sipari\u015Fte</p></div></div></div><div class="col-xl-3 col-lg-3 col-md-6 col-sm-6"><div class="tp-feature-item-2 d-flex align-items-start"><div class="tp-feature-icon-2 mr-10"><span>`);
  _push(ssrRenderComponent(_component_svg_support, null, null, _parent));
  _push(`</span></div><div class="tp-feature-content-2"><h3 class="tp-feature-title-2">7/24 Destek</h3><p>G\xFCn\xFCn 24 saati bizimle ileti\u015Fime ge\xE7in</p></div></div></div></div></div></div></section>`);
}
...
export { __nuxt_component_8 as _, category_data as c };
//# sourceMappingURL=feature-two-CZAsQXz9.mjs.map
