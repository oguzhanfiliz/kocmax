...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "product-details-list-thumb",
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "tp-product-details-thumb-list" }, _attrs))}><!--[-->`);
      ssrRenderList(_ctx.product.imageURLs, (item, i) => {
        _push(`<div class="tp-product-details-thumb-list-item mb-25 d-flex align-items-center justify-content-center" style="${ssrRenderStyle({ "background-color": "#f5f6f8" })}"><img${ssrRenderAttr("src", item.img)} alt="product-img"></div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/product-details/product-details-list-thumb.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "product-details-list-area",
  __ssrInlineRender: true,
  props: {
    product: {},
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_product_details_list_thumb = _sfc_main$2;
      ...
      _push(ssrRenderComponent(_component_product_details_list_thumb, { product: _ctx.product }, null, _parent));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/product-details/product-details-list-area.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "product-details-list",
  __ssrInlineRender: true,
  setup(__props) {
    useSeoMeta({ title: "Product Details With List Page" });
    const product = product_data[1];
    useProductStore();
    return (_ctx, _push, _parent, _attrs) => {
      const _component_product_details_breadcrumb = _sfc_main$4;
      const _component_product_details_list_area = _sfc_main$1;
      ...
      _push(ssrRenderComponent(_component_product_details_list_area, { product: unref(product) }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/product-details-list.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=product-details-list-J15ffElC.mjs.map
