import { b as _export_sfc, u as useSeoMeta, l as __nuxt_component_0$1, m as __nuxt_component_4$1, a as __nuxt_component_0$1$1, d as useRouter, i as defineStore, g as __nuxt_component_1$3, j as apiService } from './server.mjs';
import { _ as __nuxt_component_1$1 } from './right-arrow-Dgh6Y7IR.mjs';
import { _ as __nuxt_component_0$2, a as __nuxt_component_1$2 } from './next-arrow-CNy1st9n.mjs';
import { defineComponent, withCtx, createTextVNode, createVNode, createBlock, openBlock, Fragment, renderList, ref, mergeProps, unref, toDisplayString, computed, useSSRContext } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderStyle, ssrInterpolate, ssrRenderAttr } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/server-renderer/index.mjs';
...
import { Navigation, Pagination, EffectFade, Autoplay } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/swiper/modules/index.mjs';
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        _push(`<div class="d-flex justify-content-center align-items-center" style="${ssrRenderStyle({ "height": "100vh" })}" data-v-1930d73c><div class="spinner-border text-primary" role="status" data-v-1930d73c><span class="visually-hidden" data-v-1930d73c>Y\xFCkleniyor...</span></div></div>`);
      } else {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(categoryStore).isLoading) {
        _push(`<div class="row" data-v-f42ddd48><div class="col-12 text-center" data-v-f42ddd48><div class="spinner-border" role="status" data-v-f42ddd48><span class="visually-hidden" data-v-f42ddd48>Y\xFCkleniyor...</span></div><p class="mt-2" data-v-f42ddd48>Kategoriler y\xFCkleniyor...</p></div></div>`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(featuresStore).isLoading) {
        _push(`<div class="row" data-v-86186991><div class="col-12 text-center" data-v-86186991><div class="spinner-border" role="status" data-v-86186991><span class="visually-hidden" data-v-86186991>Y\xFCkleniyor...</span></div><p class="mt-2" data-v-86186991>\xD6zellikler y\xFCkleniyor...</p></div></div>`);
        ...
        ssrRenderList(unref(displayFeatures), (feature) => {
          var _a;
          _push(`<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6" data-v-86186991><div class="tp-feature-item d-flex align-items-start" data-v-86186991><div class="tp-feature-icon mr-15" data-v-86186991><span data-v-86186991>${(_a = feature.icon) != null ? _a : ""}</span></div><div class="tp-feature-content" data-v-86186991><h3 class="tp-feature-title" data-v-86186991>${ssrInterpolate(feature.title)}</h3><p data-v-86186991>${ssrInterpolate(feature.description)}</p></div></div></div>`);
        });
        _push(`<!--]--></div>`);
      }
      if (!unref(featuresStore).isLoading && !unref(featuresStore).error && unref(displayFeatures).length === 0) {
        _push(`<div class="row" data-v-86186991><div class="col-12 text-center" data-v-86186991><p data-v-86186991>Hen\xFCz \xF6zellik bulunmamaktad\u0131r.</p></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></section>`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(isLoading) && !unref(error) && unref(new_arrivals).length === 0) {
        _push(`<div class="row" data-v-25c86b45><div class="col-12 text-center py-5" data-v-25c86b45><p class="text-muted" data-v-25c86b45>Hen\xFCz yeni \xFCr\xFCn bulunmamaktad\u0131r.</p></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></section>`);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</div></div><div class="container"><div class="row align-items-center"><div class="col-xl-7 col-lg-7"><div class="tp-subscribe-content"><span>T\xFCm ma\u011Fazada %20 indirim</span><h3 class="tp-subscribe-title">B\xFCltenimize Abone Olun</h3></div></div><div class="col-xl-5 col-lg-5"><div class="tp-subscribe-form"><form action="#"><div class="tp-subscribe-input"><input type="email" placeholder="E-posta Adresinizi Girin"><button type="submit">Abone Ol</button></div></form></div></div></div></div></section>`);
}
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    useSeoMeta({ title: "Ana Sayfa - \xC7ok Ama\xE7l\u0131 E-Ticaret Sitesi" });
    return (_ctx, _push, _parent, _attrs) => {
...
//# sourceMappingURL=index-BQiiQYlD.mjs.map
