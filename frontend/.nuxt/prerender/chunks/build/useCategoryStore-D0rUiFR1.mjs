    ...
    try {
      ...
      const transformed = (data || []).map((cat) => {
        ...
        return {
          id: cat.id,
          name: cat.name,
          slug: cat.slug || ((_b = (_a2 = cat.name) == null ? void 0 : _a2.toLowerCase()) == null ? void 0 : _b.replace(/\s+/g, "-").replace(/[^a-z0-9-]/g, "")),
          description: cat.description,
          parent_id: cat.parent_id,
          image: cat.image_url || cat.image,
          is_active: cat.is_active !== false,
          level: (_a3 = cat.level) != null ? _a3 : cat.parent_id ? 1 : 0,
          children: Array.isArray(cat.children) ? cat.children.map((child) => {
            ...
            return {
              id: child.id,
              name: child.name,
              slug: child.slug || ((_b2 = (_a22 = child.name) == null ? void 0 : _a22.toLowerCase()) == null ? void 0 : _b2.replace(/\s+/g, "-").replace(/[^a-z0-9-]/g, "")),
              description: child.description,
              parent_id: child.parent_id,
              image: child.image_url || child.image,
              is_active: child.is_active !== false,
              level: (_a4 = child.level) != null ? _a4 : 1,
...
//# sourceMappingURL=useCategoryStore-D0rUiFR1.mjs.map
