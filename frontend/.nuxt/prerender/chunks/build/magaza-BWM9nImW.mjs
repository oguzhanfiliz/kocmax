...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useSeoMeta({ title: "Ma\u011Faza - \xDCr\xFCnler" });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/magaza.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=magaza-BWM9nImW.mjs.map
