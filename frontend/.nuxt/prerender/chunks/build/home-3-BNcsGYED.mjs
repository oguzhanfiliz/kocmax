import { u as useSeoMeta, l as __nuxt_component_0, g as __nuxt_component_1$3, d as useRouter, a as __nuxt_component_0$1, b as _export_sfc, q as formatPrice, p as product_data } from './server.mjs';
import { defineComponent, resolveComponent, withCtx, createVNode, mergeProps, createTextVNode, unref, ref, computed, createBlock, openBlock, Fragment, renderList, toDisplayString, useSSRContext } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderStyle, ssrInterpolate, ssrRenderAttr, ssrRenderClass } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/server-renderer/index.mjs';
import { _ as __nuxt_component_2, a as __nuxt_component_0$2 } from './plus-BEOHVp2z.mjs';
import { _ as __nuxt_component_8, c as category_data } from './feature-two-CZAsQXz9.mjs';
import { _ as _sfc_main$9 } from './product-beauty-item-BAghbZ9u.mjs';
import { _ as __nuxt_component_0$3, a as __nuxt_component_1$1 } from './next-arrow-CNy1st9n.mjs';
...
import { Pagination, Navigation, EffectFade } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/swiper/modules/index.mjs';
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_nuxt_link = __nuxt_component_0$1;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "tp-\xF6ne-\xE7\u0131kan-\xFCr\xFCn-alan\u0131 pt-70 pb-150" }, _attrs))}><div class="container"><div class="row gx-0"><!--[-->`);
      ssrRenderList(featured_data, (item) => {
        _push(`<div class="col-lg-4 col-md-6"><div class="tp-\xF6ne-\xE7\u0131kan-item-3 text-center"><div class="tp-\xF6ne-\xE7\u0131kan-thumb-3 d-flex align-items-end justify-content-center"><img${ssrRenderAttr("src", item.img)} alt="image"></div><div class="tp-\xF6ne-\xE7\u0131kan-content-3"><h3 class="tp-\xF6ne-\xE7\u0131kan-title-3">`);
        _push(ssrRenderComponent(_component_nuxt_link, { href: "/shop" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            var _a;
            if (_push2) {
              _push2(`<span${_scopeId}>${(_a = item.title) != null ? _a : ""}</span>`);
            } else {
              return [
                createVNode("span", {
        ...
        _push(`</h3><p>${ssrInterpolate(item.subtitle)}</p><div class="tp-\xF6ne-\xE7\u0131kan-price-3"><span>${ssrInterpolate(("formatPrice" in _ctx ? _ctx.formatPrice : unref(formatPrice))(item.save))} Tasarruf</span></div></div></div></div>`);
      });
      _push(`<!--]--></div></div></section>`);
    };
  }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_collection_beauty = __nuxt_component_1$3;
...
//# sourceMappingURL=home-3-BNcsGYED.mjs.map
