import { u as useSeoMeta, l as __nuxt_component_0$2, a as __nuxt_component_0$1$1, d as useRouter, o as useCartStore, p as product_data, b as _export_sfc, q as formatPrice } from './server.mjs';
import { defineComponent, withCtx, createVNode, mergeProps, unref, createTextVNode, toDisplayString, createBlock, openBlock, Fragment, renderList, createCommentVNode, ref, computed, useSSRContext } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderStyle, ssrRenderClass } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/server-renderer/index.mjs';
...
import { Navigation, Pagination, EffectFade, Scrollbar } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/swiper/modules/index.mjs';
import { _ as __nuxt_component_1 } from './right-arrow-Dgh6Y7IR.mjs';
import { _ as __nuxt_component_8, c as category_data } from './feature-two-CZAsQXz9.mjs';
import { _ as _sfc_main$e } from './product-item-C8uokGEH.mjs';
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "tp-\xF6ne-\xE7\u0131kan-slider-alan\u0131 grey-bg-6 fix pt-95 pb-120" }, _attrs))}><div class="container"><div class="row"><div class="col-xl-12"><div class="tp-section-title-wrapper-2 mb-50"><span class="tp-section-title-pre-2"> Kategoriye G\xF6re Al\u0131\u015Fveri\u015F `);
      _push(ssrRenderComponent(_component_svg_section_line_2, null, null, _parent));
      _push(`</span><h3 class="tp-section-title-2">Bu Haftan\u0131n \xD6ne \xC7\u0131kanlar\u0131</h3></div></div></div><div class="row"><div class="col-xl-12"><div class="tp-\xF6ne-\xE7\u0131kan-slider">`);
      _push(ssrRenderComponent(unref(Swiper), {
        slidesPerView: 3,
        spaceBetween: 10,
        navigation: {
          nextEl: ".tp-\xF6ne-\xE7\u0131kan-slider-button-next",
          prevEl: ".tp-\xF6ne-\xE7\u0131kan-slider-button-prev"
        },
        ...
        class: "tp-\xF6ne-\xE7\u0131kan-slider-active swiper-container"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(unref(fashion_prd), (item) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), {
                key: item.id,
                class: "tp-\xF6ne-\xE7\u0131kan-item white-bg p-relative z-index-1"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="tp-\xF6ne-\xE7\u0131kan-thumb include-bg" style="${ssrRenderStyle(`background-image:url(${item.img})`)}"${_scopeId2}></div><div class="tp-\xF6ne-\xE7\u0131kan-content"${_scopeId2}><h3 class="tp-\xF6ne-\xE7\u0131kan-title"${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_nuxt_link, {
                      href: `/product-details/${item.id}`
                    }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                    ...
                    _push3(`</h3><div class="tp-\xF6ne-\xE7\u0131kan-price-wrapper"${_scopeId2}>`);
                    if (item.discount > 0) {
                      _push3(`<div${_scopeId2}><span class="tp-\xF6ne-\xE7\u0131kan-price old-price"${_scopeId2}>${ssrInterpolate(("formatPrice" in _ctx ? _ctx.formatPrice : unref(formatPrice))(item.price, false))}</span><span class="tp-\xF6ne-\xE7\u0131kan-price new-price"${_scopeId2}>${ssrInterpolate(("formatPrice" in _ctx ? _ctx.formatPrice : unref(formatPrice))(Number(item.price) - Number(item.price) * Number(item.discount) / 100))}</span></div>`);
                    } else {
                      _push3(`<span class="tp-\xF6ne-\xE7\u0131kan-price new-price"${_scopeId2}>${ssrInterpolate(("formatPrice" in _ctx ? _ctx.formatPrice : unref(formatPrice))(item.price))}</span>`);
                    }
                    _push3(`</div><div class="tp-product-rating-icon tp-product-rating-icon-2"${_scopeId2}><span${_scopeId2}><i class="fa-solid fa-star"${_scopeId2}></i></span><span${_scopeId2}><i class="fa-solid fa-star"${_scopeId2}></i></span><span${_scopeId2}><i class="fa-solid fa-star"${_scopeId2}></i></span><span${_scopeId2}><i class="fa-solid fa-star"${_scopeId2}></i></span><span${_scopeId2}><i class="fa-solid fa-star"${_scopeId2}></i></span></div><div class="tp-\xF6ne-\xE7\u0131kan-btn"${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_nuxt_link, {
                      href: `/product-details/${item.id}`,
                    ...
                    return [
                      createVNode("div", {
                        class: "tp-\xF6ne-\xE7\u0131kan-thumb include-bg",
                        style: `background-image:url(${item.img})`
                      }, null, 4),
                      createVNode("div", { class: "tp-\xF6ne-\xE7\u0131kan-content" }, [
                        createVNode("h3", { class: "tp-\xF6ne-\xE7\u0131kan-title" }, [
                          createVNode(_component_nuxt_link, {
                            href: `/product-details/${item.id}`
                          }, {
                            default: withCtx(() => [
                        ...
                        createVNode("div", { class: "tp-\xF6ne-\xE7\u0131kan-price-wrapper" }, [
                          item.discount > 0 ? (openBlock(), createBlock("div", { key: 0 }, [
                            createVNode("span", { class: "tp-\xF6ne-\xE7\u0131kan-price old-price" }, toDisplayString(("formatPrice" in _ctx ? _ctx.formatPrice : unref(formatPrice))(item.price, false)), 1),
                            createVNode("span", { class: "tp-\xF6ne-\xE7\u0131kan-price new-price" }, toDisplayString(("formatPrice" in _ctx ? _ctx.formatPrice : unref(formatPrice))(Number(item.price) - Number(item.price) * Number(item.discount) / 100)), 1)
                          ])) : (openBlock(), createBlock("span", {
                            key: 1,
                            class: "tp-\xF6ne-\xE7\u0131kan-price new-price"
                        ...
                        createVNode("div", { class: "tp-\xF6ne-\xE7\u0131kan-btn" }, [
                          createVNode(_component_nuxt_link, {
                            href: `/product-details/${item.id}`,
                            class: "tp-btn tp-btn-border tp-btn-border-sm"
                          }, {
      ...
      _push(`<div class="tp-\xF6ne-\xE7\u0131kan-slider-arrow mt-45"><button class="tp-\xF6ne-\xE7\u0131kan-slider-button-prev">`);
      _push(ssrRenderComponent(_component_svg_slider_btn_prev, null, null, _parent));
      _push(`</button><button class="tp-\xF6ne-\xE7\u0131kan-slider-button-next">`);
...
//# sourceMappingURL=home-2-CCpzsRlY.mjs.map
