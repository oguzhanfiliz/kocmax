...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useSeoMeta({
      ...
      description: computed(() => categoryDescription.value || "Kategori \xFCr\xFCnlerini ke\u015Ffedin")
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_breadcrumb_1, {
        ...
        subtitle: unref(categoryDescription) || "Kategori \xDCr\xFCnleri"
      }, null, _parent));
...
//# sourceMappingURL=_slug_-CaVPv3Tm.mjs.map
