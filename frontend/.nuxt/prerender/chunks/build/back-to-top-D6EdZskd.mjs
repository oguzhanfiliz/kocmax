import { defineComponent, mergeProps, computed, ref, watch, unref, withCtx, createVNode, toDisplayString, createTextVNode, resolveComponent, withAsyncContext, useSSRContext } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderClass, ssrRenderAttr, ssrRenderComponent, ssrInterpolate, ssrRenderStyle, ssrIncludeBooleanAttr, ssrRenderList } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/server-renderer/index.mjs';
import { b as _export_sfc, d as useRouter, o as useCartStore, s as useWishlistStore, t as useUtilityStore, k as useAuthStore, F as useSettingsStore, i as defineStore, a as __nuxt_component_0$1$1, E as useRuntimeConfig, e as useProductStore, q as formatPrice } from './server.mjs';
import { u as useCurrencyStore } from './useCurrencyStore-DgaAunK6.mjs';
import { u as useCategoryStore } from './useCategoryStore-D0rUiFR1.mjs';
import { a as useAsyncData } from './asyncData-BfFzIJ-W.mjs';
import { _ as __nuxt_component_7 } from './wishlist-zdmcKBQo.mjs';
import { _ as __nuxt_component_8 } from './cart-bag-DzrNKPgb.mjs';
import { _ as __nuxt_component_9 } from './user-qSxYWNCZ.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(currencyStore).activeCurrencies.length > 0) {
        ...
        _push(`<ul class="${ssrRenderClass(`${unref(isActive) === "currency" ? "tp-currency-list-open" : ""}`)}" data-v-99d26308><li data-v-99d26308><span class="loading-text" data-v-99d26308>Y\xFCkleniyor...</span></li></ul>`);
      }
      ...
      ssrRenderList(unref(parentCategories), (parentCategory) => {
        ...
        if (parentCategory.children && parentCategory.children.length > 8) {
          ...
          _push(ssrRenderComponent(_component_nuxt_link, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(` T\xFCm\xFCn\xFC G\xF6r (${ssrInterpolate(parentCategory.children.length)}) `);
              } else {
                return [
                  createTextVNode(" T\xFCm\xFCn\xFC G\xF6r (" + toDisplayString(parentCategory.children.length) + ") ", 1)
                ];
              }
            }),
            _: 2
...
const useSearchStore = defineStore("search", () => {
  ...
  const rawFlag = (_b2 = (_a2 = (_b = runtimeConfig == null ? void 0 : runtimeConfig.public) == null ? void 0 : _b.NUXT_PUBLIC_USE_SUGGESTIONS) != null ? _a2 : (_c = runtimeConfig == null ? void 0 : runtimeConfig.public) == null ? void 0 : _c.useSuggestions) != null ? _b2 : true;
  ...
  const rawFallback = (_d2 = (_c2 = (_d = runtimeConfig == null ? void 0 : runtimeConfig.public) == null ? void 0 : _d.NUXT_PUBLIC_SUGGESTIONS_FALLBACK) != null ? _c2 : (_e = runtimeConfig == null ? void 0 : runtimeConfig.public) == null ? void 0 : _e.suggestionsFallback) != null ? _d2 : false;
  ...
  const searchInStore = async (query) => {
    ...
    return uniqueProducts.filter(
      (product) => {
        var _a22, _b22, _c22;
        return ((_a22 = product.name) == null ? void 0 : _a22.toLowerCase().includes(searchTerm)) || ((_b22 = product.description) == null ? void 0 : _b22.toLowerCase().includes(searchTerm)) || ((_c22 = product.brand) == null ? void 0 : _c22.toLowerCase().includes(searchTerm));
      }
    ).map((product) => {
      var _a22;
      return {
        ...
        thumbnail: ((_a22 = product.images) == null ? void 0 : _a22[0]) || "",
      ...
      if ((response == null ? void 0 : response.success) && response.data) {
        ...
        return products.map((product) => {
          ...
          return {
            ...
            thumbnail: ((_a22 = product.images) == null ? void 0 : _a22[0]) || product.thumbnail || "",
            category: product.brand || ((_b22 = product.category) == null ? void 0 : _b22.name) || "",
  ...
  const getAutocomplete = async (query) => {
    var _a22, _b22, _c22, _d22, _e2, _f;
    ...
    try {
      ...
      if (SUGGESTIONS_ENABLED && query.length >= 2 && suggestions.filter((s) => s.type === "product").length < 3) {
        try {
          ...
          const apiProducts = ((_a22 = apiResp == null ? void 0 : apiResp.data) == null ? void 0 : _a22.products) || (apiResp == null ? void 0 : apiResp.products) || [];
          for (const p of apiProducts) {
            if (suggestions.filter((s) => s.type === "product").length >= 3) break;
            const slug = p.slug || ((_c22 = (_b22 = p.id) == null ? void 0 : _b22.toString) == null ? void 0 : _c22.call(_b22)) || p.name || p.title;
      ...
      if (SUGGESTIONS_FALLBACK && suggestions.filter((s) => s.type === "product").length < 3) {
        try {
          ...
          const list = Array.isArray(resp == null ? void 0 : resp.data) ? resp.data : ((_d22 = resp == null ? void 0 : resp.data) == null ? void 0 : _d22.data) || [];
  ...
  const loadPopularSearches = async () => {
    try {
      ...
      console.error("Pop\xFCler aramalar y\xFCklenemedi:", error);
      popularSearches.value = [
        "g\xFCvenlik ayakkab\u0131s\u0131",
        "i\u015F eldiveni",
        "baret",
        "reflekt\xF6r yelek",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(searchStore).autocompleteLoading) {
        ...
        if (unref(productSuggestions).length > 0) {
          _push(`<div class="autocomplete-section" data-v-c3bdf406><h6 class="autocomplete-title" data-v-c3bdf406>\xDCr\xFCnler</h6><!--[-->`);
          ssrRenderList(unref(productSuggestions), (product) => {
            ...
            _push(`<span class="item-text" data-v-c3bdf406>${ssrInterpolate(product.text)}</span><span class="item-badge" data-v-c3bdf406>\xDCr\xFCn</span></div>`);
          });
          _push(`<!--]--></div>`);
        } else {
          _push(`<!---->`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(cartStore).totalPriceQuantity.total < unref(freeShippingThreshold)) {
        _push(`<p>${ssrInterpolate(`\xDCcretsiz kargo i\xE7in $${unref(remainingAmount).toFixed(2)} daha ekleyin`)}</p>`);
      } else {
        _push(`<p>\xDCcretsiz kargo i\xE7in uygunsunuz</p>`);
      }
      ...
      if (unref(cartStore).cart_products.length > 0) {
        ...
        ssrRenderList(unref(cartStore).cart_products, (item) => {
          ...
          if (item.discount > 0 && item.orderQuantity) {
            ...
            _push(`<span class="cartmini__price">${ssrInterpolate(("formatPrice" in _ctx ? _ctx.formatPrice : unref(formatPrice))(item.price * ((_a = item.orderQuantity) != null ? _a : 0)))}</span>`);
          }
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="offcanvas__bottom" data-v-b10983d3><div class="offcanvas__footer d-flex align-items-center justify-content-between" data-v-b10983d3><div class="offcanvas__currency-wrapper currency" data-v-b10983d3><span class="offcanvas__currency-selected-currency tp-currency-toggle" id="tp-offcanvas-currency-toggle" data-v-b10983d3>Para Birimi : TL </span><ul class="${ssrRenderClass(`offcanvas__currency-list tp-currency-list ${unref(isToggleActive) === "currency" ? "tp-currency-list-open" : ""}`)}" data-v-b10983d3><li data-v-b10983d3>TL</li><li data-v-b10983d3>USD</li><li data-v-b10983d3>EUR</li><li data-v-b10983d3>GBP</li></ul></div><div class="offcanvas__select language" data-v-b10983d3><div class="offcanvas__lang d-flex align-items-center justify-content-md-end" data-v-b10983d3><div class="offcanvas__lang-img mr-15" data-v-b10983d3><img${ssrRenderAttr("src", _imports_1)} alt="language-flag" data-v-b10983d3></div><div class="offcanvas__lang-wrapper" data-v-b10983d3><span class="offcanvas__lang-selected-lang tp-lang-toggle" id="tp-offcanvas-lang-toggle" data-v-b10983d3>T\xFCrk\xE7e </span><ul class="${ssrRenderClass(`offcanvas__lang-list tp-lang-list ${unref(isToggleActive) === "lang" ? "tp-lang-list-open" : ""}`)}" data-v-b10983d3><li data-v-b10983d3>T\xFCrk\xE7e</li><li data-v-b10983d3>\u0130ngilizce</li><li data-v-b10983d3>Almanca</li><li data-v-b10983d3>Frans\u0131zca</li></ul></div></div></div></div></div></div></div><div class="${ssrRenderClass(`body-overlay ${unref(utilsStore).openMobileMenus ? "opened" : ""}`)}" data-v-b10983d3></div><!--]-->`);
    };
  }
});
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</nav></div></div><div class="col-xl-5 col-lg-7 col-md-7 col-sm-8 col-6" data-v-bc544c99><div class="tp-header-bottom-right d-flex align-items-center justify-content-end pl-30" data-v-bc544c99><div class="tp-header-search-2 d-none d-sm-block" data-v-bc544c99><div class="${ssrRenderClass([{ "search-active": unref(showAutocomplete) }, "search-container"])}" data-v-bc544c99><form data-v-bc544c99><input type="text" placeholder="\xDCr\xFCn ara..."${ssrRenderAttr("value", unref(searchText))} autocomplete="off" data-v-bc544c99><button type="submit" data-v-bc544c99>`);
      ...
      if (unref(authStore).isAuthenticated) {
        ...
        _push(`</li><li data-v-bc544c99><hr class="dropdown-divider" data-v-bc544c99></li><li data-v-bc544c99><a class="dropdown-item text-danger" href="#" data-v-bc544c99><i class="fa-solid fa-sign-out-alt me-2" data-v-bc544c99></i>\xC7\u0131k\u0131\u015F</a></li></ul></div>`);
      } else {
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</span></div><div class="tp-footer-contact-content"><p>${(_a = unref(contactAddress)) != null ? _a : ""}</p></div></div></div>`);
    };
  }
});
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const settingsStore = useSettingsStore();
    const copyrightText = ref("\xA9 2024 T\xFCm Haklar\u0131 Sakl\u0131d\u0131r");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "tp-footer-bottom" }, _attrs))} data-v-eb0097fc><div class="container" data-v-eb0097fc><div class="tp-footer-bottom-wrapper" data-v-eb0097fc><div class="row align-items-center" data-v-eb0097fc><div class="col-md-6" data-v-eb0097fc><div class="tp-footer-copyright" data-v-eb0097fc><p data-v-eb0097fc>${(_a = unref(copyrightText)) != null ? _a : ""}</p></div></div><div class="col-md-6" data-v-eb0097fc><div class="tp-footer-payment text-md-end" data-v-eb0097fc>`);
      if (unref(paymentImageUrl) && !Array.isArray(unref(paymentImageUrl))) {
        _push(`<p data-v-eb0097fc><img${ssrRenderAttr("src", unref(paymentImageUrl))} alt="\xD6deme Y\xF6ntemleri" data-v-eb0097fc></p>`);
        ...
        ssrRenderList(unref(paymentImageUrl), (image, index) => {
          _push(`<img${ssrRenderAttr("src", image)}${ssrRenderAttr("alt", `\xD6deme Y\xF6ntemi ${index + 1}`)} class="payment-image" data-v-eb0097fc>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const footerContactTitle = computed(() => {
      return settingsStore.footerWidgetTitle || "Bizimle \u0130leti\u015Fime Ge\xE7in";
    });
    const footerDescription = computed(() => {
      return settingsStore.footerDescription || "Y\xFCksek kaliteli \xFCr\xFCnler sunan tasar\u0131mc\u0131 ve geli\u015Ftirici ekibiyiz.";
    });
...
//# sourceMappingURL=back-to-top-D6EdZskd.mjs.map
