import { defineComponent, mergeProps, unref, useSSRContext } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrInterpolate } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/server-renderer/index.mjs';
...
const brands_data = [
  ...
  },
  {
    ...
    name: "Antec",
    description: "Antec Business Support. Top Articles. Top Articles. Find Your Product. Search for your product by name, model number or part number.",
  ...
  },
  {
    ...
    name: "Lenovo",
    description: "Lenovo Business Support. Top Articles. Top Articles. Find Your Product. Search for your product by name, model number or part number.",
  ...
  },
  {
    ...
    description: "Legendary Whitetails Business Support. Top Articles. Top Articles. Find Your Product. Search for your product by name, model number or part number.",
  ...
  },
  {
    ...
    name: "Nike",
    description: "Nike Business Support. Top Articles. Top Articles. Find Your Product. Search for your product by name, model number or part number.",
  ...
  },
  {
    ...
    name: "INIKA",
    description: "inika Business Support. Top Articles. Top Articles. Find Your Product. Search for your product by name, model number or part number.",
  ...
  },
  {
    ...
    name: "Louis Vuitton",
    description: "Louis Vuitton Business Support. Top Articles. Top Articles. Find Your Product. Search for your product by name, model number or part number.",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "tp-shop-widget-content" }, _attrs))}><div class="tp-shop-widget-brand-list d-flex align-items-center justify-content-between flex-wrap"><!--[-->`);
      ssrRenderList(unref(brands_data).slice(0, 8), (item) => {
        _push(`<div class="tp-shop-widget-brand-item">`);
        if (item.logo) {
          _push(`<a class="cursor-pointer"><img${ssrRenderAttr("src", item.logo)} alt="logo"></a>`);
        } else {
          _push(`<a class="cursor-pointer">${ssrInterpolate(item.name)}</a>`);
        }
        _push(`</div>`);
      });
      _push(`<!--]--></div></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/shop/sidebar/filter-brand.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as _ };
//# sourceMappingURL=filter-brand-CBgBMllT.mjs.map
