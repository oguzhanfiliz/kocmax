import { r as useCompareStore, o as useCartStore, s as useWishlistStore, t as useUtilityStore, a as __nuxt_component_0$1, b as _export_sfc, q as formatPrice } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
        ...
        _push(ssrRenderComponent(_component_nuxt_link, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class="tp-product-tooltip tp-product-tooltip-right"${_scopeId}>Sepeti G\xF6r</span>`);
            } else {
              return [
                createVNode(_component_svg_add_cart),
                createVNode("span", { class: "tp-product-tooltip tp-product-tooltip-right" }, "Sepeti G\xF6r")
              ];
            }
          }),
          _: 1
      ...
      _push(`<span class="tp-product-tooltip tp-product-tooltip-right">H\u0131zl\u0131 \xD6nizleme</span></button><button type="button" class="${ssrRenderClass(`tp-product-action-btn-2 tp-product-add-to-wishlist-btn ${isItemInWishlist(_ctx.item) ? "active" : ""}`)}">`);
...
export { _sfc_main as _, __nuxt_component_3 as a };
//# sourceMappingURL=product-item-C8uokGEH.mjs.map
