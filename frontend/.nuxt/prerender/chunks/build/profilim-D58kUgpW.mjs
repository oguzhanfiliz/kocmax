import { u as useSeoMeta, l as __nuxt_component_0$3, b as _export_sfc, k as useAuthStore, d as useRouter } from './server.mjs';
import { _ as _sfc_main$e } from './breadcrumb-1-3lWMIEut.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderStyle, ssrInterpolate, ssrRenderClass, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderList } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/server-renderer/index.mjs';
import { defineComponent, withCtx, createVNode, mergeProps, ref, reactive, unref, computed, watch, useSSRContext } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/index.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(authStore).isLoading) {
        ...
        if (unref(formData).business_type) {
          _push(`<div class="col-xxl-6 col-md-6" data-v-9e8b798a><div class="profile__input-box" data-v-9e8b798a><label class="profile__label" data-v-9e8b798a>\u0130\u015F T\xFCr\xFC</label><div class="profile__input" data-v-9e8b798a><input type="text" placeholder="\u0130\u015F T\xFCr\xFC"${ssrRenderAttr("value", unref(formData).business_type)} readonly class="always-readonly" data-v-9e8b798a><span data-v-9e8b798a><i class="fa-solid fa-briefcase" data-v-9e8b798a></i></span></div></div></div>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (!unref(isEditing)) {
          _push(`<button type="button" class="tp-btn" data-v-9e8b798a>Profili D\xFCzenle</button>`);
        } else {
          _push(`<div class="d-flex gap-2" data-v-9e8b798a><button type="submit" class="tp-btn"${ssrIncludeBooleanAttr(unref(isSubmitting)) ? " disabled" : ""} data-v-9e8b798a>${ssrInterpolate(unref(isSubmitting) ? "G\xFCncelleniyor..." : "De\u011Fi\u015Fiklikleri Kaydet")}</button><button type="button" class="tp-btn tp-btn-border" data-v-9e8b798a>\u0130ptal</button></div>`);
        }
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isLoading)) {
        _push(`<div class="text-center p-4" data-v-de78f95f><div class="spinner-border" role="status" data-v-de78f95f><span class="visually-hidden" data-v-de78f95f>Loading...</span></div><p class="mt-2" data-v-de78f95f>Adresler y\xFCkleniyor...</p></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (!unref(isLoading)) {
        ...
        if (unref(addresses).length === 0) {
          _push(`<div class="col-12" data-v-de78f95f><div class="text-center p-4" data-v-de78f95f><p data-v-de78f95f>Hen\xFCz kay\u0131tl\u0131 adresiniz bulunmuyor.</p><button class="tp-btn" data-v-de78f95f> \u0130lk Adresinizi Ekleyin </button></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--[-->`);
        ssrRenderList(unref(addresses), (address) => {
          ...
          _push(`<p data-v-de78f95f><span data-v-de78f95f>\u015Eehir:</span> ${ssrInterpolate(address.city)}, ${ssrInterpolate(address.state)}</p><p data-v-de78f95f><span data-v-de78f95f>Posta Kodu:</span> ${ssrInterpolate(address.postal_code)}</p><p data-v-de78f95f><span data-v-de78f95f>\xDClke:</span> ${ssrInterpolate(getCountryName(address.country))}</p>`);
          if (address.phone) {
          ...
          _push(`<p data-v-de78f95f><span data-v-de78f95f>T\xFCr:</span> ${ssrInterpolate(getAddressTypeText(address.type))}</p></div></div></div>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useSeoMeta({
      ...
      description: "Kullan\u0131c\u0131 profil sayfas\u0131 - hesap bilgilerinizi g\xF6r\xFCnt\xFCleyin ve d\xFCzenleyin"
    });
    return (_ctx, _push, _parent, _attrs) => {
...
//# sourceMappingURL=profilim-D58kUgpW.mjs.map
