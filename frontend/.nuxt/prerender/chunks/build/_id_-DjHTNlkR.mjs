import { b as _export_sfc, c as useRoute, e as useProductStore, j as apiService, u as useSeoMeta, a as __nuxt_component_0$1 } from './server.mjs';
...
import { defineComponent, computed, withAsyncContext, watch, unref, withCtx, createTextVNode, useSSRContext } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/server-renderer/index.mjs';
import { u as useLazyAsyncData } from './asyncData-BfFzIJ-W.mjs';
...
import 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/perfect-debounce/dist/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(pending)) {
        _push(`<div class="container py-5" data-v-0bd50935><div class="text-center" data-v-0bd50935><div class="spinner-border text-primary" role="status" data-v-0bd50935><span class="visually-hidden" data-v-0bd50935>Y\xFCkleniyor...</span></div><p class="mt-3" data-v-0bd50935>\xDCr\xFCn bilgileri y\xFCkleniyor...</p></div></div>`);
      } else if (unref(error) && !unref(product)) {
        _push(`<div class="container py-5" data-v-0bd50935><div class="text-center" data-v-0bd50935><h2 data-v-0bd50935>\xDCr\xFCn Bulunamad\u0131</h2><p class="text-muted" data-v-0bd50935>Arad\u0131\u011F\u0131n\u0131z \xFCr\xFCn mevcut de\u011Fil (ID: ${ssrInterpolate(unref(productId))}) veya kald\u0131r\u0131lm\u0131\u015F olabilir.</p>`);
        _push(ssrRenderComponent(_component_nuxt_link, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`\xDCr\xFCnleri G\xF6r`);
            } else {
              return [
                createTextVNode("\xDCr\xFCnleri G\xF6r")
              ];
            }
          }),
          _: 1
        ...
        _push(`<div class="container py-5" data-v-0bd50935><div class="text-center" data-v-0bd50935><h3 data-v-0bd50935>Bir sorun olu\u015Ftu</h3><p data-v-0bd50935>Sayfa y\xFCkleniyor...</p><button class="btn btn-secondary" data-v-0bd50935>Sayfay\u0131 Yenile</button></div></div>`);
      }
      _push(`</div>`);
    };
  }
...
//# sourceMappingURL=_id_-DjHTNlkR.mjs.map
