...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "shop-right-sidebar",
  __ssrInlineRender: true,
  setup(__props) {
    useSeoMeta({ title: "Shop Right Sidebar Page" });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_shop_area, { shop_right_side: true }, null, _parent));
      _push(`</div>`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/shop-right-sidebar.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=shop-right-sidebar-Duvp7oWr.mjs.map
