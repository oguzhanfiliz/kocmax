...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "shop-full-width",
  __ssrInlineRender: true,
  setup(__props) {
    useSeoMeta({ title: "Shop Full Width Page" });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_breadcrumb_1, {
        ...
        subtitle: "Shop Full Width",
        full_width: true
      }, null, _parent));
      _push(ssrRenderComponent(_component_shop_area, { full_width: true }, null, _parent));
      _push(`</div>`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/shop-full-width.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=shop-full-width-CRWXRvvD.mjs.map
