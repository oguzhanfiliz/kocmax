...
import { defineComponent, computed, mergeProps, unref, useSSRContext } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderStyle } from 'file:///Users/oguzhanfiliz/Desktop/calisma/B2B-B2C-main/frontend/node_modules/vue/server-renderer/index.mjs';
import { u as useCategoryStore } from './useCategoryStore-D0rUiFR1.mjs';
import { u as useSeoMeta, d as useRouter } from './server.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(categoryStore).isLoading) {
        _push(`<div class="row"><div class="col-12 text-center"><div class="spinner-border" role="status"><span class="visually-hidden">Y\xFCkleniyor...</span></div><p class="mt-2">Kategoriler y\xFCkleniyor...</p></div></div>`);
        ...
        ssrRenderList(unref(displayCategories), (category) => {
          _push(`<div class="col-lg-3 col-sm-6"><div class="tp-category-main-box mb-25 p-relative fix" style="${ssrRenderStyle({ "background-color": "#f3f5f7" })}"><div class="tp-category-main-content"><h3 class="tp-category-main-title pb-1"><a class="cursor-pointer">${ssrInterpolate(category.name)}</a></h3><span class="tp-category-main-item">${ssrInterpolate(category.products_count || 0)} \xDCr\xFCn </span></div></div></div>`);
        });
        _push(`<!--]--></div>`);
      }
      if (!unref(categoryStore).isLoading && !unref(categoryStore).error && unref(displayCategories).length === 0) {
        _push(`<div class="row"><div class="col-12 text-center"><p>Hen\xFCz kategori bulunmamaktad\u0131r.</p></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></section>`);
...
//# sourceMappingURL=shop-categories-CdK7kDpg.mjs.map
