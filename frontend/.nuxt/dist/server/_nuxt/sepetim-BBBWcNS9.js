import { o as useCartStore, a as __nuxt_component_0, q as formatPrice, v as __nuxt_component_1, w as __nuxt_component_2, u as useSeoMeta, l as __nuxt_component_0$1 } from "../server.mjs";
import { _ as _sfc_main$3 } from "./breadcrumb-1-3lWMIEut.js";
import { _ as __nuxt_component_1$1 } from "./remove-Bjvs3pKg.js";
import { defineComponent, withCtx, createVNode, createTextVNode, toDisplayString, unref, useSSRContext, ref, mergeProps } from "vue";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_svg_minus = __nuxt_component_1;
      const _component_svg_plus_sm = __nuxt_component_2;
      const _component_svg_remove = __nuxt_component_1$1;
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(cartStore).cart_products.length === 0) {
        _push(`<div className="text-center pt-50"><h3>Sepette Ürün Bulunamadı</h3>`);
        _push(ssrRenderComponent(_component_nuxt_link, {
          href: "/shop",
        ...
        _push(`<div class="row"><div class="col-xl-9 col-lg-8"><div class="tp-cart-list mb-25 mr-30"><table><thead><tr><th colspan="2" class="tp-cart-header-product">Ürün</th><th class="tp-cart-header-price">Fiyat</th><th class="tp-cart-header-quantity">Adet</th><th></th></tr></thead><tbody><!--[-->`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useSeoMeta({
      ...
      description: "Alışveriş sepetinizdeki ürünleri görüntüleyin ve yönetin"
    });
    return (_ctx, _push, _parent, _attrs) => {
...
//# sourceMappingURL=sepetim-BBBWcNS9.js.map
