import { b as _export_sfc, o as useCartStore, s as useWishlistStore, t as useUtilityStore, a as __nuxt_component_0, q as formatPrice } from "../server.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span class="tp-product-tooltip">Hızlı Önizleme</span></button><button type="button" class="${ssrRenderClass(`tp-product-action-btn-3 tp-product-add-to-wishlist-btn ${isItemInWishlist(_ctx.item) ? "active" : ""}`)}">`);
...
//# sourceMappingURL=product-beauty-item-BAghbZ9u.js.map
