import { _ as __nuxt_component_0$1, a as _sfc_main$3, b as __nuxt_component_2, c as __nuxt_component_3, d as __nuxt_component_0$2, e as __nuxt_component_1$1 } from "./list-EYpKfql_.js";
import { mergeProps, useSSRContext, defineComponent, computed, unref, ref, watch } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderList } from "vue/server-renderer";
import { b as _export_sfc, c as useRoute, d as useRouter, e as useProductStore, f as useProductFilterStore, g as __nuxt_component_1$2 } from "../server.mjs";
import { _ as _sfc_main$4 } from "./filter-select-Dm58trrY.js";
import { _ as _sfc_main$5 } from "./pagination-bqOOOfR4.js";
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(hasActiveFilters)) {
        ...
        _push(`<div class="tp-shop-active-filter-clear" data-v-6231fd83><button class="tp-shop-active-filter-clear-btn" type="button" data-v-6231fd83> Tüm Filtreleri Temizle </button></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ProductElectronicsItem = __nuxt_component_1$2;
      const _component_ui_pagination = _sfc_main$5;
      ...
      _push(`</button></li></ul></div><div class="tp-shop-top-result"><p>${ssrInterpolate(unref(productStore).meta.total > 0 ? `${unref(startIndex) + 1}–${Math.min(unref(endIndex), unref(productStore).meta.total)} arası gösteriliyor, toplam ${unref(productStore).meta.total} sonuç` : "Sonuç bulunamadı")}</p></div></div></div><div class="col-xl-6">`);
      ...
      if (unref(productStore).isLoading) {
        _push(`<div class="text-center py-5"><div class="spinner-border" role="status"><span class="visually-hidden">Loading...</span></div><p class="mt-2">Ürünler yükleniyor...</p></div>`);
        ...
        if (!((_b = unref(productStore).products) == null ? void 0 : _b.length)) {
          _push(`<div class="col-12 text-center py-5"><p>Ürün bulunamadı.</p></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
...
//# sourceMappingURL=shop-area-C5aVbQff.js.map
